This is an genetic algorithmn implementation using the explanation from the book An Introduction to Genetic Algorithms by Melanie Mitchell in chapter 1.6 A SIMPLE GENETIC ALGORITHM.
